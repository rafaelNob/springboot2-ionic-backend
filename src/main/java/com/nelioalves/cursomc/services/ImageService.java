...
public class ImageService {
	...
	public BufferedImage getJpgImageFromFile(MultipartFile uploadedFile) {
		...
		if(!"png".equals(ext) && !"jpg".equals(ext)) {
			throw new FileException("Somente imagem png e jpg são permitidos");
		}
	...
	/**
	 * Metodo para que p mulipartFile consiga ler o arquivo
	 * @param img
	 * @param extension
	 * @return InputStream
	 */
	...
	public BufferedImage cropResize(BufferedImage sourceImg,int size) {
